...
#plt.hist(data["Main Total"],normed=True,alpha=.7)
plt.hist(data["Total.1"],20,normed=True, color="#6495ED", alpha=.5)
plt.hist(data['Total.2'],20, normed=True, color="#F08080", alpha=.5)
